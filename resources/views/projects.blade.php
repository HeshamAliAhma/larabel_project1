...
@section('content')
    <div class="projects-page d-grid m-20 gap-20">
        <div class="project bg-white p-20 rad-6 p-relative">
            ...
            <div class="team">
                <a href="#"><img src="{{asset('style/image/team-1.png')}}" alt="" /></a>
                <a href="#"><img src="{{asset('style/image/team-2.png')}}" alt="" /></a>
                <a href="#"><img src="{{asset('style/image/team-3.png')}}" alt="" /></a>
                <a href="#"><img src="{{asset('style/image/team-4.png')}}" alt="" /></a>
                <a href="#"><img src="{{asset('style/image/team-5.png')}}" alt="" /></a>
            </div>
            <div class="do d-flex">
