    ...
    <div class="files-content d-grid gap-20">
        <div class="file bg-white p-10 rad-10">
            ...
            <div class="icon txt-c">
                <img class="mt-15 mb-15" src="{{asset('style/images/pdf.svg')}}" alt="" />
            </div>
        ...
        <div class="file bg-white p-10 rad-10">
            <i class="fa-solid fa-download c-grey p-absolute"></i>
            <div class="icon txt-c">
                <img class="mt-15 mb-15" src="{{asset('style/images/avi.svg')}}" alt="" />
            </div>
        ...
        <div class="file bg-white p-10 rad-10">
            <i class="fa-solid fa-download c-grey p-absolute"></i>
            <div class="icon txt-c">
                <img class="mt-15 mb-15" src="{{asset('style/images/psd.svg')}}" alt="" />
            </div>
        ...
        <div class="file bg-white p-10 rad-10">
            <i class="fa-solid fa-download c-grey p-absolute"></i>
            <div class="icon txt-c">
                <img class="mt-15 mb-15" src="{{asset('style/images/dll.svg')}}" alt="" />
            </div>
